...
def vqa_processing(image_dir, annotation_file, annotation_caption_file,question_file, valid_answer_set, image_set):
    ...
    for n_q, q in enumerate(questions):
        ...
        question_str = trans(q['question'])
        question_tokens = hannanum.morphs(question_str)
        ...
        if load_answer:
            ...
            for arr in caption_arr:
                korarr = trans(arr)
                caption_arr_tokens.append(hannanum.morphs(korarr))
...
def main(args):
    ...
    vocab_answer_file = 'D:/data/vqa/coco/simple_vqa' + '/ko_vocab_answers.txt'
    ...
    np.save('D:/data/vqa/coco/simple_vqa' + '/kotrain.npy', np.array(train))
    np.save('D:/data/vqa/coco/simple_vqa' + '/kovalid.npy', np.array(valid))
    np.save('D:/data/vqa/coco/simple_vqa' + '/kotrain_valid.npy', np.array(train + valid))
    np.save('D:/data/vqa/coco/simple_vqa' + '/kotest.npy', np.array(test))
    np.save('D:/data/vqa/coco/simple_vqa' + '/kotest-dev.npy', np.array(test_dev))
