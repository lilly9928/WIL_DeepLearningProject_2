        ...
        for sid in qc_nodes:
            if qid != sid:
                if qid in conceptnet_cache:
                    ...
                    q_data = fetch_conceptnet_graph(qid)
                ...
                if sid in conceptnet_cache:
                    ...
                    s_data = fetch_conceptnet_graph(sid)
...
def process_data(item):
    if isinstance(item, str):
        item = json.loads(item)  # 문자열을 사전으로 변환
    #data 가져오기
...
if __name__ == '__main__':
    ...
    output_path = '/data2/KJE/OK-VQA/statement/updated_OpenEnded_mscoco_val2014_questions_processed_promptcap_relation.jsonl'
