...
class CustomDataset(Dataset):
    def __init__(self, tokenizer, data_file, max_length=512):
        ...
        for item in data:
            ...
            context_parts = [item['image_caption'], item['relation']]
...
data_file = '/data2/KJE/OK-VQA/statement/updated_OpenEnded_mscoco_val2014_questions_processed_promptcap_relation.jsonl'  # Update this to your dataset file path
