...
def main():
    ...
    routines = {
            'vcr': [
            # {'func': ground, 'args': (output_paths['vcr']['statement']['sample'], output_paths['cpnet']['vocab'],
            #                           output_paths['cpnet']['patterns'], output_paths['vcr']['grounded']['sample'], args.nprocs)},
            #     {'func': generate_adj_data_from_grounded_concepts__use_LM, 'args': (
            #     output_paths['vcr']['grounded']['sample'], output_paths['cpnet']['pruned-graph'],
            #     output_paths['cpnet']['vocab'], output_paths['vcr']['graph']['adj-sample'], args.nprocs)},


            {'func': ground, 'args': (output_paths['vcr']['statement']['train'], output_paths['cpnet']['vocab'],
                                          output_paths['cpnet']['patterns'], output_paths['vcr']['grounded']['train'],
                                          args.nprocs)},
            {'func': generate_adj_data_from_grounded_concepts__use_LM, 'args': (output_paths['vcr']['grounded']['train'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['vcr']['graph']['adj-train'], args.nprocs)},
                {'func': ground, 'args': (output_paths['vcr']['statement']['dev'], output_paths['cpnet']['vocab'],
                                          output_paths['cpnet']['patterns'], output_paths['vcr']['grounded']['dev'],
                                          args.nprocs)},
            ...
            {'func': generate_adj_data_from_grounded_concepts__use_LM, 'args': (output_paths['vcr']['grounded']['test'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['vcr']['graph']['adj-test'], args.nprocs)},
        ],
        'common': [
