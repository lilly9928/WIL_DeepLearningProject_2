...
def load_sparse_adj_data_with_contextnode(adj_pk_path, max_node_num, num_choice, args):
    ...
    if use_cache:
        ...
        n_samples = len(adj_concept_pairs) #this is actually n_questions x n_choices (74*4)
        ...
        for idx, _data in tqdm(enumerate(adj_concept_pairs), total=n_samples, desc='loading adj matrices'):
            adj, concepts, qm, am, cid2score,iqm,iam,icid2score = _data['adj'], _data['concepts'], _data['qmask'], _data['amask'], _data['cid2score'], _data['i2qmask'], _data['i2amask'], _data['icid2score'],
    ...
    print('concept_ids_shape:',concept_ids.shape)
        ...
        for ex_index, example in enumerate(tqdm(examples)):
            ...
            for ending_idx, (context, ending,caption) in enumerate(zip(example.contexts, example.endings, example.caption)):
                ...
                if tokens_c:
                    ...
                    segment_ids += [sequence_a_segment_id] * (len(tokens_c) + 1)
