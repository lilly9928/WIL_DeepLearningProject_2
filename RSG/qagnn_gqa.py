...
def main():
    ...
    parser.add_argument('--save_dir', default=f'/data2/KJE/RSG/saved_models/qagnn/', help='model output directory')
                ...
                for a in range(0, bs, args.mini_batch_size):
                    ...
                    if args.fp16:
                        with torch.cuda.amp.autocast():
                            logits, _ = model(*[x[a:b] for x in input_data], layer_id=args.encoder_layer, cache_output=True)
