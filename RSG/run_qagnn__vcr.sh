...
for seed in 0; do
  python3 -u qagnn.py --dataset $dataset \
      ...
      --train_adj /data2/KJE/${dataset}/graph/sample.graph.adj.pk \
      --dev_adj   /data2/KJE/${dataset}/graph/sample.graph.adj.pk \
      --test_adj  /data2/KJE/${dataset}/graph/sample.graph.adj.pk \
      --train_statements  /data2/KJE/${dataset}/statement/sample.statement.jsonl \
      --dev_statements  /data2/KJE/${dataset}/statement/sample.statement.jsonl \
